...
todo:
-в задаче(вопросе) где есть фото, фото при вызове полноэеранного режима выделяется, это не нужно.
-убрать что относится к настройкам в отдельное меню настройки, админку тоже из профиля убрать и поместить в подходящее место.
-добавить смену акцентного цвета из пресетов цветов.
-переделать стиль приложения, сделать красивее, анимации и тд.
-кнопки в меню назад и тд, переделать под стиль вписать в меню.
-подчистить этот файл от ненужного но оставить нужное
