...
<section class="screen" id="screen-random-count" data-screen="random-count">
  <!-- Обёрнуто в .profile-card — раньше этот экран был единственным
       "менюшным" экраном без рамки (см. .split у ChaptersScreen,
       .profile-card у Profile/Settings/Credits) — кнопка выхода теперь
       тоже внутри рамки, а не отдельным элементом над ней (как и на
       остальных card-экранах). -->
  <div class="profile-card random-count-card">
